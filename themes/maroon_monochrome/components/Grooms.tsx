...
const Grooms = () => {
  ...
  return (
    ...
    >
      ...
      {/* Content box */}
      <div
        className={`${playfair.className} gap-3 flex flex-col justify-center items-start absolute bottom-0 z-20 w-full bg-gradient-to-b from-slate-white via-white/50 to-slate-50/50 px-6 py-8 backdrop-blur-sm`}
        data-aos="fade-up"
        data-aos-offset="100"
      >
        <h2
