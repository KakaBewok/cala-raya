...
const Grooms = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2
          className={`max-w-[80%] text-left tracking-widest text-2xl text-[#fff] drop-shadow-xs drop-shadow-slate-500`}
        >
          {data?.host_one_name}
        </h2>
        <p className="text-xs font-semibold text-white max-w-[50%] text-left drop-shadow-xs drop-shadow-slate-400">
