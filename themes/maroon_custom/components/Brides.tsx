...
const Brides = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2
          className={`max-w-[80%] text-right tracking-widest text-2xl text-[#fff] drop-shadow-xs drop-shadow-slate-500`}
        >
          {data?.host_two_name}
        </h2>
        <p className="text-xs font-semibold text-white max-w-[50%] text-right tracking-wide drop-shadow-xs drop-shadow-slate-400">
      ...
      <Image
        ...
        width={100}
        height={100}
        className="swing-right-slow absolute -bottom-7 -left-7 z-30 transform rotate-[32deg]"
      />
      <Image
